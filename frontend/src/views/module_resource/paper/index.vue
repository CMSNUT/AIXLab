  ...
  <div class="app-container">
    ...
    <div v-show="visible" class="search-container">
      ...
      >
        ...
        <el-form-item label="来源(期刊/书名等)" prop="source">
          <el-input v-model="queryFormData.source" placeholder="请输入来源(期刊/书名等)" clearable />
        </el-form-item>
    ...
    >
      ...
      <template v-if="dialogVisible.type === 'detail'">
        <el-descriptions :column="4" border>
          ...
          <el-descriptions-item label="来源(期刊/书名等)" :span="2">
      ...
      <template v-else>
        ...
        >
          ...
          <el-form-item label="来源(期刊/书名等)" prop="source" :required="false">
            <el-input v-model="formData.source" placeholder="请输入来源(期刊/书名等)" />
          </el-form-item>
...
const tableColumns = ref([
  ...
  { prop: "source", label: "来源(期刊/书名等)", show: true },
...
const rules = reactive({
  ...
  type: [{ required: false, message: "请输入文章类型", trigger: "blur" }],
  field: [{ required: false, message: "请输入文章领域", trigger: "blur" }],
  title: [{ required: true, message: "请输入标题", trigger: "blur" }],
  source: [{ required: false, message: "请输入来源(期刊/书名等)", trigger: "blur" }],
  year: [{ required: false, message: "请输入年份", trigger: "blur" }],
  volume: [{ required: false, message: "请输入卷", trigger: "blur" }],
  issue: [{ required: false, message: "请输入期", trigger: "blur" }],
  pages: [{ required: false, message: "请输入页码", trigger: "blur" }],
  doi: [{ required: false, message: "请输入DOI", trigger: "blur" }],
  pmid: [{ required: false, message: "请输入PubMed ID", trigger: "blur" }],
  ...
  if (selectIds.value.length) {
    ElMessageBox.confirm(`确认${status === "0" ? "启用" : "停用"}该项数据?`, "警告", {
      ...
      .then(async () => {
        try {
          loading.value = true;
          await ResourcePaperAPI.batchResourcePaper({ ids: selectIds.value, status });
          handleResetQuery();
        } catch (error: any) {
          console.error(error);
        } finally {

...
class ResourcePaperModel(ModelMixin, UserMixin):
    """
    文献表
    """
    ...
    field: Mapped[str | None] = mapped_column(String(10), nullable=True, comment='文章领域')
    title: Mapped[str | None] = mapped_column(String(300), nullable=True, comment='标题')
    source: Mapped[str | None] = mapped_column(String(300), nullable=True, comment='来源(期刊/书名等)')
    ...
    doi: Mapped[str | None] = mapped_column(String(300), nullable=True, comment='DOI')

...
class ResourceKitCreateSchema(BaseModel):
    """
    模块新增模型
    """
    name: str  | None = Field(default=None, description='模块名称')
    type: str  | None = Field(default=None, description='模块类型')
    language: str  | None = Field(default=None, description='编程语言')
    description: str  | None = Field(default=None, description='备注/描述')
    local_path: str  | None = Field(default=None, description='本地文件')
    network_url: str  | None = Field(default=None, description='网络地址')
    cloud_url: str  | None = Field(default=None, description='网盘地址')


class ResourceKitUpdateSchema(ResourceKitCreateSchema):
    """
    模块更新模型
    """
    ...
...
class ResourceKitOutSchema(ResourceKitCreateSchema, BaseSchemaModify, UserBySchema):
    """
    模块响应模型
    """
...
class ResourceKitQueryParam:
    ...
    def __init__(
        ...
        type: str | None = Query(None, description="模块类型"),
        language: str | None = Query(None, description="编程语言"),
        local_path: str | None = Query(None, description="本地文件"),

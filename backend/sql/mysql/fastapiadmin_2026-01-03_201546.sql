...
--
-- Host: 127.0.0.1    Database: aixlab
-- ------------------------------------------------------
...
INSERT INTO `sys_param` VALUES ('网站名称','sys_web_title','巴莱侠-AIXLab',1,1,'f8821461-4cf7-4a82-adf7-b770d08845ac','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('网站描述','sys_web_description','巴莱侠-AIXLab 是完全开源的权限管理系统',1,2,'ff33eab0-fdfa-48e5-9c74-fc58d222d8f5','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('网页图标','sys_web_favicon','https://service.aixlab.com/api/v1/static/image/favicon.png',1,3,'9457e932-11f7-4934-a0dd-afde24442bc4','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('网站Logo','sys_web_logo','https://service.aixlab.com/api/v1/static/image/logo.png',1,4,'a44f8d04-cf77-4116-8d85-421467f4c4c9','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('登录背景','sys_login_background','https://service.aixlab.com/api/v1/static/image/background.svg',1,5,'4516b274-d45a-4d84-a9c7-07aaff32af1c','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('版权信息','sys_web_copyright','Copyright © 2025-2026 service.aixlab.com 版权所有',1,6,'e6d2ecaf-0aef-46bd-a780-454212c4310e','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('备案信息','sys_keep_record','陕ICP备2025069493号-1',1,7,'5a7f0bdc-6c7d-4e22-8885-b69ad1c18a8a','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('帮助文档','sys_help_doc','https://service.aixlab.com',1,8,'7a4ab36e-2b0b-426f-a973-7a0f54e987f9','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('隐私政策','sys_web_privacy','https://github.com/CMSNUT/AIXLab/blob/master/LICENSE',1,9,'c4d0d089-7e7a-40d5-828d-e7d0798fbff6','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('用户协议','sys_web_clause','https://github.com/CMSNUT/AIXLab/blob/master/LICENSE',1,10,'0f9891e2-c044-4195-8414-dd2520595a92','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('源码代码','sys_git_code','https://github.com/CMSNUT/AIXLab.git',1,11,'16a0c6cf-3e54-414c-ba7d-761d074ffb99','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('项目版本','sys_web_version','2.0.0',1,12,'ed3e3c09-927a-4298-9594-7369ab348bfa','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('演示模式启用','demo_enable','false',1,13,'e0305279-8e92-48c8-849d-28df2956ae56','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('演示访问IP白名单','ip_white_list','[\"127.0.0.1\"]',1,14,'5ee61c8b-6e96-4414-9792-98ad92898798','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('接口白名单','white_api_list_path','[\"/api/v1/system/auth/login\", \"/api/v1/system/auth/token/refresh\", \"/api/v1/system/auth/captcha/get\", \"/api/v1/system/auth/logout\", \"/api/v1/system/config/info\", \"/api/v1/system/user/current/info\", \"/api/v1/system/notice/available\"]',1,15,'f51f0052-3629-432d-87a8-bb821f443894','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40'),('访问IP黑名单','ip_black_list','[]',1,16,'c7cfa114-6a19-4be0-8c44-f75522069349','0','初始化数据','2026-01-03 20:15:40','2026-01-03 20:15:40');
...
INSERT INTO `sys_user` VALUES ('admin','$2b$12$e2IJgS/cvHgJ0H3G7Xa08OXoXnk6N/NX3IZRtubBDElA0VLZhkNOa','超级管理员',NULL,NULL,'0','https://service.aixlab.com/api/v1/static/image/avatar.png',1,NULL,NULL,NULL,NULL,NULL,1,1,'e5d8aae9-8f73-4d99-8e4e-19ef8c1df901','0','超级管理员','2026-01-03 20:15:40','2026-01-03 20:15:40',NULL,NULL);
...
--
-- Dumping routines for database 'aixlab'
--

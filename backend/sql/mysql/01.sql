...
CREATE TABLE `project_member` (
  ...
  `role` varchar(10) DEFAULT NULL COMMENT '成员角色',
  ...
  `updated_id` int DEFAULT NULL COMMENT '更新人ID',
  PRIMARY KEY (`id`),
  KEY `ix_project_member_subject_id` (`subject_id`),
  KEY `ix_project_member_role` (`role`),
  KEY `ix_project_member_member_id` (`member_id`),
  CONSTRAINT `fk_project_member_created_id` FOREIGN KEY (`created_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_project_member_updated_id` FOREIGN KEY (`updated_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_project_member_subject_id` FOREIGN KEY (`subject_id`) REFERENCES `project_subject` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_project_member_member_id` FOREIGN KEY (`member_id`) REFERENCES `sys_user` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='研究成员表';

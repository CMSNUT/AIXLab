...
class ResourcePaperCreateSchema(BaseModel):
    ...
    source: str | None = Field(default=None, description='来源(期刊/书名等)')
...
class ResourcePaperOutSchema(ResourcePaperCreateSchema, BaseSchema, UserBySchema):
    """
    文献响应模型
    """
...
class ResourcePaperQueryParam:
    ...
    def __init__(
        ...
        source: str | None = Query(None, description="来源(期刊/书名等)"),

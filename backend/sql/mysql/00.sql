...
CREATE TABLE `resource_paper` (
  ...
  KEY `ix_resource_paper_title` (`title`(100)),
...
CREATE TABLE `resource_author` (
  ...
  `institution` varchar(500) DEFAULT NULL COMMENT '机构/单位',
  ...
  KEY `ix_resource_author_name` (`name`(100)),
  KEY `ix_resource_author_institution` (`institution`(100)),
...
CREATE TABLE `resource_data` (
  ...
  `format` varchar(10) DEFAULT NULL COMMENT '数据格式',
  `description` text DEFAULT NULL COMMENT '备注/描述',
  ...
  `created_id` int DEFAULT NULL COMMENT '创建人ID',
  `updated_id` int DEFAULT NULL COMMENT '更新人ID',
  KEY `ix_resource_data_name` (`name`(100)),
...
CREATE TABLE `resource_script` (
  ...
  `type` varchar(10) DEFAULT NULL COMMENT '脚本类型',
...
CREATE TABLE `resource_kit` (
  ...
  `type` varchar(10) DEFAULT '基础图表' COMMENT '模块类型',
  `language` varchar(10) DEFAULT 'Python' COMMENT '编程语言',
  `description` text DEFAULT NULL COMMENT '备注/描述',
  `local_path` varchar(1000) DEFAULT NULL COMMENT '本地文件',
  `network_url` varchar(1000) DEFAULT NULL COMMENT '网络地址',
  `cloud_url` varchar(1000) DEFAULT NULL COMMENT '网盘地址',
...
CREATE TABLE `resource_corpus` (
  ...
  `paper_id` int DEFAULT NULL COMMENT '文献ID',
  `section` varchar(10) DEFAULT NULL COMMENT '文章章节',

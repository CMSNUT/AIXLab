...
class Settings(BaseSettings):
    ...
    ACCESS_TOKEN_EXPIRE_MINUTES: int = 60 * 300  # access_token过期时间(秒)300 分钟
    REFRESH_TOKEN_EXPIRE_MINUTES: int = 60 * 300  # refresh_token过期时间(秒)300 分钟
    ...
    DATABASE_USER: str = "aikemi"
    DATABASE_PASSWORD: str = "snut3426"
    DATABASE_NAME: str = "aixlab_db"

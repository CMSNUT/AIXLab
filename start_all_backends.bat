...
start "Py314-Service" cmd /k "echo 正在启动Python子服务... %PY_314_PATH% && echo 激活conda环境... && call "%CONDA_PATH%\Scripts\activate.bat" %PY_314_ENV% && cd /d "%PY_314_PATH%" && python "%PY_314_SCRIPT%" && pause"
...
echo.
echo ✅ 所有服务已启动！
echo 📌 Python子服务：%PY_314_ENV%环境（独立CMD窗口）

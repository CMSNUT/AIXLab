...
class ResourceScriptModel(ModelMixin, UserMixin):
    """
    脚本表
    """
    __tablename__: str = 'resource_script'
    __table_args__: dict[str, str] = {'comment': '脚本'}
    __loader_options__: list[str] = ["created_by", "updated_by"]

    name: Mapped[str | None] = mapped_column(String(500), nullable=True, comment='脚本名称')
    type: Mapped[str | None] = mapped_column(String(100), nullable=True, comment='脚本类型')
